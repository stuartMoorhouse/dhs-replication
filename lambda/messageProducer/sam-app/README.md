...
```bash
my-application$ sam local invoke getUrisFromDhsAndProduceMessages --no-event
```
...
Resources:
  MyQueue:
    Type: AWS::SQS::Queue
  getUrisFromDhsAndProduceMessages:
    Type: AWS::Serverless::Function
    Properties:
      Handler: src/handlers/getUrisFromDhsAndProduceMessages.handler
      Runtime: nodejs12.x
      DeadLetterQueue:
        Type: SQS
...
```bash
my-application$ sam logs -n getUrisFromDhsAndProduceMessages --stack-name sam-app --tail
```
